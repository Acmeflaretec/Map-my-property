      ...
      <Box sx={{ flexGrow: 1 }} display={"flex"} justifyContent={"center"}>
        <Grid container spacing={2} maxWidth={{ md: 600, lg: 800 }} py={5} px={1}>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="caption">( Important blogs will be shown in home page )</Typography>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Typography variant="caption">Blog Display Type *(applicable for important blogs)</Typography>
            <Select
              name="type"
              value={data?.type || ""}
              onChange={handleChange}
