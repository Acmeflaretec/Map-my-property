...
const HeroSection: React.FC = () => {
  return (
    <div className="relative flex flex-col items-center text-gray-800 gap-4 mt-20 md:mt-28 mx-1 md:mx-4 p-1 lg:mt-32 md:px-8 h-[50vh] md:h-[70vh] bg-[#C2D4E5] rounded-3xl">
      <SentenceAnimation
      ...
      <div className="absolute hidden md:flex bg-white border-2 mb-2 -bottom-12 w-[95%] lg:w-4/5 xl:w-2/3 h-28 rounded-3xl p-2">
        <div className="w-[35%] p-4 flex flex-col gap-2">
        ...
        <div className="w-[30%] border-x-2 border-stone-200 flex items-center justify-between p-4">
        ...
        <div className="w-[35%] flex p-4 items-center justify-between">
          <p>₹ Budget</p>
          <Icons.rightArrow />
          <CustomButton type="primary">
            Search <Icons.search />
